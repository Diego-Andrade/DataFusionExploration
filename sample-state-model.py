...
# Data:        11/30/2022
# Description:
# An example of a state model for a simple differential drive robot with
...
#   Xt = At-1*Xt-1 + Bt-1 * Xt-1 + NOISEt-1
#
...
#   Xt = [ x_t, y_t, yaw_t ] 
# where is x and y are measure in meters and yaw in rads.
#
